...
const SALES_EMAIL = "info@grewalshopfrontandshutters.co.uk";
const FROM_EMAIL = "Grewal Shopfront & Shutters <noreply@grewalshopfrontandshutters.co.uk>";
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #f9fafb; padding: 24px; border-radius: 8px;">
      <div style="background: #1a1a2e; padding: 24px; border-radius: 8px 8px 0 0; text-align: center;">
        ...
        <p style="color: #e8c876; margin: 8px 0 0; font-size: 14px;">Grewal Shopfront & Shutters Enquiry</p>
      </div>
      ...
      <div style="background: #ffffff; padding: 24px; border-radius: 0 0 8px 8px; border: 1px solid #e5e7eb;">
        ...
        <div style="margin-top: 24px; text-align: center;">
          <a href="https://wa.me/447597630000?text=Hi%20${encodeURIComponent(lead.name)}%2C%20thank%20you%20for%20your%20enquiry"
...
export async function sendAutoReply(
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #f9fafb; padding: 24px; border-radius: 8px;">
      <div style="background: #1a1a2e; padding: 32px 24px; border-radius: 8px 8px 0 0; text-align: center;">
        <h1 style="color: #d4a843; margin: 0; font-size: 26px; letter-spacing: -0.5px;">Grewal Shopfront & Shutters</h1>
      ...
      <div style="background: #ffffff; padding: 32px 24px; border-radius: 0 0 8px 8px; border: 1px solid #e5e7eb;">
        ...
        <div style="background: #f9fafb; border-radius: 8px; padding: 20px; margin-bottom: 24px;">
          <p style="margin: 0 0 12px; font-size: 14px; color: #374151;">
            📞 <a href="tel:+447597630000" style="color: #1a1a2e; font-weight: 600;">07597 630000</a>
          </p>
          <p style="margin: 0 0 12px; font-size: 14px; color: #374151;">
            💬 <a href="https://wa.me/447597630000" style="color: #1a1a2e; font-weight: 600;">WhatsApp us</a>
          </p>
          <p style="margin: 0; font-size: 14px; color: #374151;">
            📧 <a href="mailto:info@grewalshopfrontandshutters.co.uk" style="color: #1a1a2e; font-weight: 600;">info@grewalshopfrontandshutters.co.uk</a>
          </p>
        </div>

        <div style="text-align: center;">
          <a href="https://www.grewalshopfrontandshutters.co.uk/gallery"
        ...
        <p style="font-size: 12px; color: #9ca3af; text-align: center; margin: 0;">
          Grewal Shopfront & Shutters Ltd · Registered in England &amp; Wales<br />
          <a href="https://www.grewalshopfrontandshutters.co.uk/unsubscribe" style="color: #9ca3af;">Unsubscribe</a>
        </p>
      </div>
    </div>
  `;
  ...
  const { error } = await getResendClient().emails.send({
    from: FROM_EMAIL,
    to: email,
    subject: "We've received your enquiry – Grewal Shopfront & Shutters",
    html,
  });
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #f9fafb; padding: 24px; border-radius: 8px;">
      ...
      <div style="background: #ffffff; padding: 32px 24px; border-radius: 0 0 8px 8px; border: 1px solid #e5e7eb;">
        ...
        <div style="background: #f9fafb; border: 2px solid #d4a843; border-radius: 8px; padding: 24px; text-align: center; margin-bottom: 20px;">
        ...
        <div style="background: #fffbeb; border-left: 4px solid #d4a843; padding: 14px 16px; margin: 20px 0; border-radius: 0 6px 6px 0;">
        ...
        <div style="text-align: center; margin-bottom: 20px;">
          <a href="tel:+447597630000"
             style="display: inline-block; background: #d4a843; color: #1a1a2e; padding: 13px 26px; border-radius: 6px; text-decoration: none; font-weight: 700; font-size: 15px; margin: 0 4px 8px;">
            Call 07597 630000
          </a>
          <a href="https://wa.me/447597630000?text=${encodeURIComponent(`Hi, I just got an instant estimate${data.reference ? ` (ref ${data.reference})` : ""} for ${data.serviceName} and would like to discuss it.`)}"
        ...
        <div style="text-align: center;">
          <a href="https://www.grewalshopfrontandshutters.co.uk/gallery" style="color: #6b7280; font-size: 13px;">See recent projects</a>
          <span style="color: #d1d5db;"> · </span>
          <a href="https://www.grewalshopfrontandshutters.co.uk/reviews" style="color: #6b7280; font-size: 13px;">Read reviews</a>
        </div>

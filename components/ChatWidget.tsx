  ...
  async function sendMessage(content: string) {
    ...
    try {
      ...
      const assistantMsg: Message = {
        role: 'assistant',
        content: data.message || 'Sorry, I couldn\'t get a response. Please call us on 07597 630000.',
      };
      ...
      setMessages((prev) => [
        ...
        {
          role: 'assistant',
          content: 'Sorry, something went wrong. Please call us on 07597 630000.',
        },
      ]);
    } finally {
      setTyping(false);
      ...
      >
        {open && (
          <div
            ...
            style={{ height: '500px' }}
            role="dialog"
            aria-label="Grewal Assistant chat"
          >
            <div className="bg-navy px-4 py-3 flex items-center justify-between flex-shrink-0">
              <div className="flex items-center gap-2">
                ...
                <span className="font-heading font-bold text-white text-sm">Grewal Assistant</span>
              </div>
              <button
                ...
                <>
                  ...
                  {messages.length >= MAX_MESSAGES && (
                    <p className="text-center text-xs text-grey-400 py-2">
                      ...
                      {' '}or call{' '}
                      <a href="tel:07597630000" className="text-gold underline">07597 630000</a>.
                    </p>
                  )}

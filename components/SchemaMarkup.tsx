...
const defaultLocalBusiness = {
  ...
  foundingDate: '2004',
  priceRange: '££',
  image: 'https://www.grewalshopfrontandshutters.co.uk/assets/shopfront-2.jpeg',
  logo: 'https://www.grewalshopfrontandshutters.co.uk/assets/shopfront-2.jpeg',
  ...
  hasOfferCatalog: {
    ...
    itemListElement: [
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Security Roller Shutters', url: 'https://www.grewalshopfrontandshutters.co.uk/services/security-roller-shutters' } },
      ...
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Steel Security Doors', url: 'https://www.grewalshopfrontandshutters.co.uk/services/steel-security-doors' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Industrial Shutters', url: 'https://www.grewalshopfrontandshutters.co.uk/services/industrial-shutters' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Automatic Sliding Doors', url: 'https://www.grewalshopfrontandshutters.co.uk/services/automatic-sliding-doors' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Toughened Glass Shopfronts', url: 'https://www.grewalshopfrontandshutters.co.uk/services/toughened-glass-shopfronts' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Electric Roller Shutters', url: 'https://www.grewalshopfrontandshutters.co.uk/services/electric-roller-shutters' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Fire Doors', url: 'https://www.grewalshopfrontandshutters.co.uk/services/fire-doors' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Scissor Gates', url: 'https://www.grewalshopfrontandshutters.co.uk/services/scissor-gates' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'PVC Strip Curtains', url: 'https://www.grewalshopfrontandshutters.co.uk/services/pvc-strip-curtains' } },
      ...
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Bollards', url: 'https://www.grewalshopfrontandshutters.co.uk/services/bollards' } },
    ],
  },
  sameAs: [

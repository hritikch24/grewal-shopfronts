        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          <div className="lg:col-span-1">
            ...
            <p className="text-grey-400 text-sm leading-relaxed mb-4">
              Professional shopfront and shutter installation and repair specialists. Serving businesses across the UK with quality aluminium shopfronts, roller shutters, security doors and more.
            </p>
            <p className="text-grey-300 text-xs">
              31 Trelawney Road, Exhall, Coventry, CV7 9FB
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                ...
                >
                  <EmailIcon />
                  <span>info@grewalshopfrontandshutters.co.uk</span>
                </a>
              </li>
              <li className="flex items-start gap-2 text-grey-400 text-sm">
                ...
                <div>
                  <p>Mon–Sat: 8am–6pm</p>
                  <p className="text-gold font-medium">Emergency: 24/7</p>
                </div>
              </li>
            </ul>
          </div>
      ...
      <div className="border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-grey-400 text-sm">
            &copy; {new Date().getFullYear()} Grewal Shopfront & Shutters. All rights reserved.
          </p>

...
export const metadata: Metadata = {
  ...
  description:
    'Read the Terms and Conditions for Grewal Shopfront & Shutters Limited. Our standard terms cover quotations, payment, installation, warranties, and your rights as a customer.',
  alternates: {
    canonical: '/terms',
  },
};
      ...
      <div className="container-max">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose-content space-y-10 text-grey-700 leading-relaxed">
            ...
            <section>
              <p>
                These Terms and Conditions (&ldquo;Terms&rdquo;) govern all quotations, orders, and contracts entered into by <strong className="text-navy">Grewal Shopfront & Shutters Limited</strong> (Company Reg: England & Wales), registered in England and Wales (<strong className="text-navy">&ldquo;the Company&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo;</strong>) with our customers (&ldquo;you&rdquo;). Please read them carefully before engaging our services.
              </p>
              <p className="mt-4">
            ...
            <section>
              ...
              <dl className="mt-4 space-y-3">
                <div className="grid grid-cols-[auto_1fr] gap-x-4">
                  <dt className="font-semibold text-charcoal min-w-[130px]">&ldquo;Contract&rdquo;</dt>
                ...
                <div className="grid grid-cols-[auto_1fr] gap-x-4">
                  <dt className="font-semibold text-charcoal min-w-[130px]">&ldquo;Goods&rdquo;</dt>
                ...
                <div className="grid grid-cols-[auto_1fr] gap-x-4">
                  <dt className="font-semibold text-charcoal min-w-[130px]">&ldquo;Business Customer&rdquo;</dt>
            ...
            <section>
              ...
              <p className="mt-4">
                5.5 All Goods supplied remain the property of Grewal Shopfront & Shutters Limited until payment in full has been received.
              </p>
            </section>

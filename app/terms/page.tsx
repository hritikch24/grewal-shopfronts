...
export const metadata: Metadata = {
  title: 'Terms & Conditions | Grewal Shopfront & Shutters',
  description:
      ...
      <div className="container-max">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose-content space-y-10 text-grey-700 leading-relaxed">
            ...
            <section>
              <p>
                These Terms and Conditions (&ldquo;Terms&rdquo;) govern all quotations, orders, and contracts entered into by <strong className="text-white">Grewal Shopfront & Shutters Limited</strong> (Company Reg: England & Wales), registered in England and Wales (<strong className="text-white">&ldquo;the Company&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo;</strong>) with our customers (&ldquo;you&rdquo;). Please read them carefully before engaging our services.
              </p>
              <p className="mt-4">
            ...
            <section>
              ...
              <address className="not-italic mt-4 pl-4 border-l-4 border-gold space-y-1">
                <p className="font-semibold text-white">Grewal Shopfront & Shutters Limited</p>
                <p>
                  Email:{' '}
                  <a

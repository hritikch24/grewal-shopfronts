...
export const metadata: Metadata = {
  ...
  description:
    'Affordable shopfront installation & shutter specialists across the UK. Aluminium shopfronts, roller shutters, security doors, automatic doors & emergency repairs. Competitive prices, free site surveys, 500+ projects completed. Call for a free quote today.',
  keywords: [
  ...
  openGraph: {
    ...
    title: 'Grewal Shopfront & Shutters | Affordable Shopfront & Shutter Specialists UK',
    description:
      'Affordable shopfront installation & shutter specialists across the UK. Aluminium shopfronts, roller shutters, security doors, automatic doors & emergency repairs. Competitive prices, free site surveys, 500+ projects completed.',
    images: [
      {
        url: `${siteUrl}/assets/shopfront-2.jpeg`,
        width: 1200,
        height: 630,
        alt: 'Grewal Shopfront & Shutters — Affordable Shopfront Installation UK',
      },
    ],
  },
  twitter: {

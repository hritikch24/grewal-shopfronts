...
export default function DocumentsAdminPage() {
  ...
  function sendWhatsApp(doc: Doc) {
    ...
    if (doc.type === 'auto-quote') {
      ...
      msg = `Hi ${first}, thanks for using our instant estimate for ${what} (ref ${doc.number}). Your guide price was £${lo} – £${hi}. I'd like to arrange a free site survey so we can confirm an exact fixed price — when suits you? — Grewal Shopfront & Shutters`;
    } else {
      const label = doc.type === 'invoice' ? 'invoice' : 'quote';
      msg = `Hi ${first}, here's your ${label} ${doc.number} from Grewal Shopfront & Shutters:\n${linkFor(doc)}`;
    }

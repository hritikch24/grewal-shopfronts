...
const WA_NUMBER = '447597630000';
const SITE_URL = 'https://www.grewalshopfrontandshutters.co.uk';
...
export default function DocumentsAdminPage() {
  ...
  function sendWhatsApp(doc: Doc) {
    ...
    const msg = `Hi ${doc.customerName.split(' ')[0]}, here's your ${label} ${doc.number} from Grewal Shopfront & Shutters:\n${linkFor(doc)}`;

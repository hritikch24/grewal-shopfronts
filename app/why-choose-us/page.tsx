...
export const metadata: Metadata = {
  title: 'Why Choose Grewal Shopfront & Shutters | Best UK Shopfront Company',
  description:
    'Discover why Grewal Shopfront & Shutters is the best shopfront company in the UK. Companies House registered, 10+ years combined experience, nationwide coverage across 16 cities, and 24/7 emergency response.',
  alternates: {
    canonical: 'https://www.grewalshopfrontandshutters.co.uk/why-choose-us',
  },
  openGraph: {
    title: 'Why Choose Grewal Shopfront & Shutters | Best UK Shopfront Company',
    description:
    ...
    url: 'https://www.grewalshopfrontandshutters.co.uk/why-choose-us',
  },
};
...
const comparisons = [
  { grewal: 'Written workmanship guarantees', typical: 'Verbal promises with no paperwork' },
  { grewal: 'Companies House registered', typical: 'Unregistered traders' },
  { grewal: 'CSCS-carded, trained installers', typical: 'Untrained or uncarded labour' },
  { grewal: 'Full insurance documentation provided', typical: 'No certificates or compliance records' },
  { grewal: 'Dedicated project manager on every job', typical: 'No single point of contact' },
  { grewal: 'Post-installation inspection and sign-off', typical: 'Walk away once fitted' },
];

const testimonials = [
  { name: 'James Whitfield', business: 'Whitfield & Sons Butchers', location: 'Leeds', quote: 'Grewal replaced our roller shutter in under a day. Genuinely one of the best trade experiences we have had.' },
  ...
  { name: 'Fiona Campbell', business: 'Campbell Opticians', location: 'Edinburgh', quote: 'Listed building constraints made this tricky. Grewal navigated planning approval and delivered beautifully.' },
];
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0', borderRadius: '0.75rem', overflow: 'hidden' }}>
            ...
            {comparisons.map((c, i) => (
              <div key={i} style={{ display: 'contents' }}>
                <div style={{ padding: '0.75rem 1rem', background: i % 2 === 0 ? '#f0fdf4' : '#fff', fontSize: '0.95rem' }} className="text-charcoal">&#10003; {c.grewal}</div>

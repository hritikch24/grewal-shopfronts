      ...
      <section className="bg-gradient-dark section-padding">
        <div className="container-max">
          ...
          <h1 className="mt-6 text-4xl md:text-5xl font-heading font-bold text-white leading-tight">
            About <span className="text-gradient-gold">Grewal Shopfront & Shutters</span>
          </h1>
          <p className="mt-4 max-w-2xl text-lg text-grey-300 leading-relaxed">
            A Coventry-based specialist in the design, fabrication, and installation of commercial
            shopfronts and security shutters — trusted by businesses across the United Kingdom for over 20 years.
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-grey-600 leading-relaxed">
                <p>
                  Grewal Shopfront & Shutters was founded in 2004 in Exhall, Coventry, by a team of experienced
                  shopfront and shutter engineers who recognised that many businesses were struggling to find a
                  contractor who could deliver consistent quality, honest pricing, and dependable aftercare all
                  under one roof. We set out to change that — and over 20 years later, that founding principle
                  still guides everything we do.
                </p>
                <p>
                  From our base in Coventry, we have grown steadily into a nationally recognised specialist in
                  shopfronts and shutters — completing installations for independent retailers, restaurant
                  chains, office developments, supermarkets, and leisure venues across England, Wales, and
                  Scotland. Our growth has been driven not by aggressive marketing, but by two decades of
                  recommendations from satisfied clients who trust us to look after their premises.
                </p>
                <p>
                  ...
                  how we do business, and we are proud to be a legitimate, regulated UK company with over 20
                  years of trading history.
                </p>
                <p>
                  Today, Grewal Shopfront & Shutters offers a complete turnkey service: from initial site survey and
                  bespoke design through to professional fabrication, installation, and long-term maintenance of
                  shopfronts and shutters. Whether you need a single replacement shopfront panel or a multi-unit
                  rollout across a retail estate, we have the skills and capacity — built over 20 years in the
                  trade — to deliver on time and within budget.
                </p>
              </div>
            </div>
        ...
        <div className="container-max">
          ...
          <div className="space-y-4 text-grey-600 leading-relaxed max-w-3xl mb-12">
            <p>
              ...
              shopfitting, shutter, and glazing industries. Every member of the team has undergone the relevant
              health and safety training, holds valid CSCS cards where applicable, and is supported by a
              proactive management team based here in Coventry.
            </p>
            <p>
      ...
      <section className="section-padding bg-grey-50">
        <div className="container-max">
          <h2 className="text-3xl font-heading font-bold text-white mb-6">
            Why Businesses Choose Grewal Shopfront & Shutters
          </h2>
          <div className="grid md:grid-cols-2 gap-8 text-grey-600 leading-relaxed">
            <div className="space-y-4">
              <p>
                In a market crowded with contractors who over-promise and under-deliver, Grewal Shopfront & Shutters has

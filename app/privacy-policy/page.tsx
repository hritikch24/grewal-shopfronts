...
export const metadata: Metadata = {
  ...
  description:
    'Read the Privacy Policy for Grewal Shopfront & Shutters Limited. Learn how we collect, use, and protect your personal data in accordance with UK GDPR.',
  alternates: {
      ...
      <div className="container-max">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose-content space-y-10 text-grey-700 leading-relaxed">
            ...
            <section>
              <p>
                Grewal Shopfront & Shutters Limited (<strong className="text-navy">&ldquo;we&rdquo;, &ldquo;us&rdquo;, or &ldquo;our&rdquo;</strong>) is committed to protecting and respecting your privacy. This policy explains what personal data we collect, how we use it, and your rights in relation to it. We comply with the UK General Data Protection Regulation (UK GDPR) and the Data Protection Act 2018.
              </p>
              <p className="mt-4">
            ...
            <section>
              ...
              <address className="not-italic mt-4 pl-4 border-l-4 border-gold space-y-1">
                <p className="font-semibold text-charcoal">Grewal Shopfront & Shutters Limited</p>
            ...
            <section>
              ...
              <div className="mt-4 space-y-4">
                <div className="pl-4 border-l-2 border-grey-200">
                  <p className="font-semibold text-charcoal">Legitimate Interests (Article 6(1)(f))</p>
                  <p className="mt-1">
                ...
                <div className="pl-4 border-l-2 border-grey-200">
                  <p className="font-semibold text-charcoal">Contractual Necessity (Article 6(1)(b))</p>
                  <p className="mt-1">
                ...
                <div className="pl-4 border-l-2 border-grey-200">
                  <p className="font-semibold text-charcoal">Consent (Article 6(1)(a))</p>
                  <p className="mt-1">
                ...
                <div className="pl-4 border-l-2 border-grey-200">
                  <p className="font-semibold text-charcoal">Legal Obligation (Article 6(1)(c))</p>
                  <p className="mt-1">
            ...
            <section>
              ...
              <div className="mt-4 space-y-4">
                <div>
                  <p className="font-semibold text-charcoal">Strictly Necessary Cookies</p>
                  <p className="mt-1">
                    Required for the website to function correctly (e.g. session management). These cannot be disabled.
                  </p>
                </div>
                <div>
                  <p className="font-semibold text-charcoal">Analytics Cookies</p>
                  <p className="mt-1">
            ...
            <section>
              ...
              <div className="mt-4 space-y-4">
                ...
                <div className="pl-4 border-l-2 border-grey-200">
                  <p className="font-semibold text-charcoal">Right to Data Portability</p>
                ...
                <div className="pl-4 border-l-2 border-grey-200">
                  <p className="font-semibold text-charcoal">Right to Object</p>
                ...
                <div className="pl-4 border-l-2 border-grey-200">
                  <p className="font-semibold text-charcoal">Right to Restrict Processing</p>
                ...
                <div className="pl-4 border-l-2 border-grey-200">
                  <p className="font-semibold text-charcoal">Right to Withdraw Consent</p>
            ...
            <section>
              ...
              <address className="not-italic mt-4 pl-4 border-l-4 border-gold space-y-1">
                <p className="font-semibold text-charcoal">Information Commissioner&rsquo;s Office</p>

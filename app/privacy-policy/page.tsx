...
export const metadata: Metadata = {
  title: 'Privacy Policy | Grewal Shopfront & Shutters',
  description:
      ...
      <div className="container-max">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose-content space-y-10 text-grey-700 leading-relaxed">
            ...
            <section>
              <p>
                Grewal Shopfront & Shutters Limited (<strong className="text-white">&ldquo;we&rdquo;, &ldquo;us&rdquo;, or &ldquo;our&rdquo;</strong>) is committed to protecting and respecting your privacy. This policy explains what personal data we collect, how we use it, and your rights in relation to it. We comply with the UK General Data Protection Regulation (UK GDPR) and the Data Protection Act 2018.
              </p>
              <p className="mt-4">

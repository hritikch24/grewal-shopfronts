...
export const metadata: Metadata = {
  ...
  description:
    'Definitions of common shopfront industry terms including aluminium extrusion, thermal breaks, fire ratings, security standards, and glazing specifications. A reference guide from Grewal Shopfront & Shutters.',
  alternates: {
    canonical: 'https://www.grewalshopfrontandshutters.co.uk/glossary',
  },
  openGraph: {
    title: 'Shopfront Glossary | Grewal Shopfront & Shutters',
    description:
      'A comprehensive glossary of shopfront, glazing, and commercial door terminology used across the UK industry.',
    url: 'https://www.grewalshopfrontandshutters.co.uk/glossary',
  },
};
...
export default function GlossaryPage() {
  const schemaData = {
    ...
    '@type': 'DefinedTermSet',
    '@id': 'https://www.grewalshopfrontandshutters.co.uk/glossary#termset',
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'BreadcrumbList',
            itemListElement: [
              { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://www.grewalshopfrontandshutters.co.uk' },
              { '@type': 'ListItem', position: 2, name: 'Glossary', item: 'https://www.grewalshopfrontandshutters.co.uk/glossary' },
            ],
          }),
        }}
      />

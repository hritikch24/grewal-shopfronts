...
function getStaticRecommendation(answers: Answers): Recommendation {
  ...
  if (primaryNeed === "emergency") {
    return {
      ...
      cta: "Call 07597 630000 now for immediate response.",
    };
  }
  ...
  if (primaryNeed === "repair") {
    return {
      ...
      cta: "Call 07597 630000 to arrange a same-day repair.",
    };
  }
  ...
  if (priority === "security") {
    return {
      ...
      cta: "Call 07597 630000 for a free security assessment.",
    };
  }
  ...
  if (priority === "aesthetics") {
    return {
      ...
      cta: "Call 07597 630000 for a free design consultation.",
    };
  }
  ...
  if (priority === "efficiency") {
    return {
      ...
      cta: "Call 07597 630000 for a free energy assessment.",
    };
  }
  ...
  if (priority === "budget") {
    return {
      ...
      cta: "Call 07597 630000 for a free quote — we'll find a solution within your budget.",
    };
  }
  ...
  return {
    ...
    cta: "Call 07597 630000 for a free site survey and exact quote.",
  };
}
...
Respond in JSON format only:
{
  ...
  "cta": "A specific, helpful call-to-action mentioning phone 07597 630000"
}
...
Available services: Aluminium Shopfronts (£2,800-£6,500), Roller Shutters (£1,200-£3,500), Security Doors (£1,800-£4,500), Automatic Doors (£3,500-£8,000), Bi-Fold Doors (£3,000-£7,000), Fire Doors (£450-£1,200/door), Shopfront Repairs (£300-£2,000), Emergency Callout (24/7), Shutter Repair (£150-£1,200), Glass Replacement (£200-£1,800).`;
    ...
    const response = await client.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: "You are a shopfront installation expert at Grewal Shopfront & Shutters, a UK-wide commercial shopfront company. Respond ONLY with valid JSON. Be practical, specific, and helpful. Use British English.",
        },

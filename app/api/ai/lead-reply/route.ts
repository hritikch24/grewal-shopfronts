...
STYLE: British English, conversational professional — like a knowledgeable tradesman who's good with people. No corporate fluff. Short paragraphs. Sign off as Grewal Shopfront & Shutters team with phone 07597 630000.
  ...
  "body": "Full email body. Line breaks between paragraphs."
    ...
    const response = await client.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: "You are the senior sales person at Grewal Shopfront & Shutters, a UK-wide shopfront installation company based in Exhall, Coventry. 15+ years in the trade. You write emails that feel personal and knowledgeable — never templated. You focus on understanding the customer's situation before selling. Phone: 07597 630000. Respond ONLY with valid JSON.",
        },

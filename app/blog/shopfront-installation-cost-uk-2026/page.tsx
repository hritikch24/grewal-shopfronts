      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            url: `https://www.grewalshopfrontandshutters.co.uk/blog/${slug}`, datePublished: '2026-06-13', dateModified: '2026-06-13',
      ...
      <article className="section-padding bg-obsidian-light">
        <div className="container-max max-w-3xl">
          ...
          <p className="text-charcoal leading-relaxed mb-6">
            ...
            <Link href="/contact" className="text-gold font-medium hover:underline">Grewal Shopfront & Shutters</Link>, all site surveys are free, and our quotations break down every cost element so you can make an informed decision.
          </p>
